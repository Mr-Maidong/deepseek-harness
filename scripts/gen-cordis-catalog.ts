...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  gitSummary: 'workspace.md',
  workspaceSearch: 'workspace.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WorkspaceGitSummaryRequest: 'workspace.md',
  WorkspaceGitSummaryValue: 'workspace.md',
  ...
  WorkspaceSearchRequest: 'workspace.md',
  WorkspaceSearchValue: 'workspace.md',
  WorkspaceSearchResult: 'workspace.md',
