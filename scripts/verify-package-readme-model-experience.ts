...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/git-summary': { kind: 'none', reason: 'The GUI-host git-state seam registers nothing model-facing.' },
  'packages/host/workspace-search': { kind: 'none', reason: 'The GUI-host workspace-search seam registers nothing model-facing.' },
